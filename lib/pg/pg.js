...
/**
 * Функция увеличивающая текущее значение счетчика запросов
 * из одного стека
 */
pg.__incrementStackCounter = function() {
  pg.__stackDeepCounter = pg.__stackDeepCounter + 1;
};
