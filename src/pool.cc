...
void
pool_spawn_connection(pool_t * pool)
{
...
void
pool_init(pool_t * pool, size_t max_size, const char * connection_info,
...
void
pool_exec(pool_t * pool, query_t * query)
{
...
void
pool_handle_error(pool_t * pool, char * error)
{
